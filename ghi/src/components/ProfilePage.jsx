...
//         e.preventDefault();
//         try {
//             const { pool_id, start_time, end_time } = newReservation;
            
//             await createReservation({ pool_id, start_time, end_time }).unwrap();
...
//     const handleCalendarReserve = (newReservation) => {
//         const { pool_id } = newReservation;
//         const start_time = newReservation.start.toISOString();
//         const end_time = newReservation.end.toISOString();
//         setNewReservation({ pool_id, start_time, end_time });
...
//                         {pools && pools.length > 0 && (
//                             <MyCalendar 
//                                 reservations={pools.reduce((acc, pool) => [...acc, ...pool.reservations], [])} 
//                                 onReserve={(newReservation) => handleCalendarReserve({ ...newReservation, pool_id: pools[0].id })} 
//                             />
//                         )}
//                     </div>
//                     <form onSubmit={handleReservationSubmit}>
